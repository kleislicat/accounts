...
*(**Accounts Microservice**, from **Udemy Course** - Master Microservices with Spring Boot, Docker, Kubernetes)*
...
|------------------------------------------------------------------------------------------------------------------------------| ------------- |
| "docker build . -t kleislicat/accounts:s4"                                                                                   | To generate a docker image based on a Dockerfile |
| "docker run  -p 8080:8080 kleislicat/accounts:s4"                                                                             | To start a docker container based on a given image |
| "docker images"                                                                                                              | To list all the docker images present in the Docker server |
| "docker image inspect image-id"                                                                                              | To display detailed image information for a given image id |
| "docker image rm image-id"                                                                                                   | To remove one or more images for a given image ids |
| "docker image push docker.io/kleislicat/accounts:s4"                                                                          | To push an image or a repository to a registry |
| "docker image pull docker.io/kleislicat/accounts:s4"                                                                          | To pull an image or a repository from a registry |
